...
import yesman.epicfight.forgecompat.client.ConfigScreenHandler;
import yesman.epicfight.forgecompat.client.event.RegisterClientReloadListenersEvent;
import yesman.epicfight.forgecompat.common.MinecraftForge;
import yesman.epicfight.forgecompat.event.AddPackFindersEvent;
import yesman.epicfight.forgecompat.event.AddReloadListenerEvent;
import yesman.epicfight.forgecompat.event.BuildCreativeModeTabContentsEvent;
import yesman.epicfight.forgecompat.event.RegisterCommandsEvent;
...
import yesman.epicfight.forgecompat.fml.event.lifecycle.FMLCommonSetupEvent;
import yesman.epicfight.forgecompat.fml.event.lifecycle.FMLConstructModEvent;
