...
import yesman.epicfight.forgecompat.client.event.EntityRenderersEvent;
import yesman.epicfight.forgecompat.client.event.EntityRenderersEvent.RegisterRenderers;
import yesman.epicfight.forgecompat.client.event.ModelEvent;
import yesman.epicfight.forgecompat.client.event.RegisterGuiOverlaysEvent;
import yesman.epicfight.forgecompat.client.event.RegisterParticleProvidersEvent;
