...
public class MirrorAnimation extends StaticAnimation {
	...
	public MirrorAnimation(float transitionTime, boolean repeatPlay, AnimationAccessor<? extends MirrorAnimation> accessor, String path1, String path2, AssetAccessor<? extends Armature> armature) {
		...
		this.original = new DirectStaticAnimation(transitionTime, repeatPlay, new ResourceLocation(accessor.registryName().getNamespace(), path1), armature);
		this.mirror = new DirectStaticAnimation(transitionTime, repeatPlay, new ResourceLocation(accessor.registryName().getNamespace(), path2), armature);
	}
