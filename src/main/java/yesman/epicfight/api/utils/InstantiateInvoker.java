...
public class InstantiateInvoker {
	...
	private static AssetAccessor<? extends Armature> getArmature(String id) {
		if (EpicFightSharedConstants.isPhysicalClient()) {
			return DatapackEditScreen.getCurrentScreen() != null ? DatapackEditScreen.getArmature(id) : Armatures.getOrCreate(new ResourceLocation(id), Armature::new);
		} else {
			return Armatures.getOrCreate(new ResourceLocation(id), Armature::new);
		}
	}
